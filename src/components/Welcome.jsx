...
const Welcome = () => {
    ...
    return <section id='welcome'>
        <p ref={subtitleRef}>{renderText("Hey, I'm Lokesh! Welcome to my", 'text-2xl sm:text-3xl font-georama', 100)}</p>
        <h1 ref={titleRef} className='mt-7'>{renderText("Portfolio", 'text-7xl sm:text-9xl italic font-georama sm:font-black')}</h1>
